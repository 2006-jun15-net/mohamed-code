...
//                optionsBuilder.UseSqlServer("Server=tcp:salam2020.database.windows.net,1433;Initial Catalog=Chinook;Persist Security Info=False;User ID=arman7rm;Password=CRonaldo7@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Enrollment>(entity =>
            {
                ...
                entity.HasIndex(e => e.CourseId)
                    .HasName("UQ__Enrollme__C92D7186B42D77E8")
                    .IsUnique();

                entity.HasIndex(e => e.StudentId)
                    .HasName("UQ__Enrollme__32C52B98436A8CFA")
                    .IsUnique();
